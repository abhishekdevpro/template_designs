...
import Certification from "./Certifications2";
...
import { SummaryWrapper, TextWrapper } from "./Common2";
...
import EducationSection from "./Education2";
...
const Template30 = () => {
  ...
  return (
    <div className=" " style={{ fontFamily: `${selectedFont}` }}>
      ...
      <div className="mb-9">
        {<h2 className="text-xl text-black font-bold mb-4" style={{ color: backgroundColorss }}>Contact</h2>}
