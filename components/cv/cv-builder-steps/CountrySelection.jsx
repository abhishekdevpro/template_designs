    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-100 flex flex-col">
      <main className="flex-1 flex flex-col items-center px-4 py-10">
        <div className="max-w-3xl text-center mb-10">
          ...
          <p className="text-md md:text-lg text-primary hover:text-primary/90 ">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {[
              ...
              <button
                ...
                className="p-5 rounded-2xl shadow-md border border-gray-200 bg-blue-200 hover:bg-primary hover:text-white hover:shadow-xl flex flex-col items-center transition-all duration-200 group"
              >
                <Image
                  src={country.flag}
                  alt={country.name}
